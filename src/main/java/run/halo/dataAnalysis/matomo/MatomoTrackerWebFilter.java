...
public class MatomoTrackerWebFilter implements AdditionalWebFilter {
    ...
    private final PluginSettingsGetter pluginSettingsGetter;
    ...
    public Mono<Void> filter(ServerWebExchange exchange, WebFilterChain chain) {
        ...
        TrackerConfiguration trackerConfiguration = initConfiguration();
     ...
     * @return
     */
    public TrackerConfiguration initConfiguration(){

        PluginSettings.BaseSettings basicSettings = pluginSettingsGetter.getBasicSettings().blockOptional().orElseThrow();
